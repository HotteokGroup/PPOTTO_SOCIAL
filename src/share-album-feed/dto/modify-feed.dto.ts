...
export class ModifyShareAlbumFeedItem {
...
export class ModifyShareAlbumFeedRequest {
  @ApiProperty({ description: '피드 내용', example: '피드 내용' })
  @IsOptional()
  @IsString()
  description?: string;

  @ApiProperty({ description: '피드 콘텐츠', type: [ModifyShareAlbumFeedItem] })
  @IsOptional()
  @IsArray()
  @ArrayMinSize(1)
  @Type(() => ModifyShareAlbumFeedItem)
  contents?: ModifyShareAlbumFeedItem[];
}
